...
install_core_packages() {
    ...
    local packages=("git" "curl" "jq" "fish" "tmux" "1password-cli" "gh" "chezmoi" "starship" "fnm" "tailscale" "git-town" "jj" "act" "terminal-notifier" "pyenv" "hammerspoon" "switchaudio-osx" "opentofu" "uv" "go" "cloudflared")
    local to_install=()
...
echo -e "${GRAY}Version 71 | Last changed: Add cloudflared to core packages${NC}"
