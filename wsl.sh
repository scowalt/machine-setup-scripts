...
# HEADLESS=1
# Paseo release channel (beta by default; set this in Windows for its client)
# PASEO_CHANNEL=beta
# WORK_MACHINE=1
...
run_setup_tasks() {
    ...
    echo -e "${GRAY}Version 203 | Last changed: Enforce durable shared Node activation across setup platforms${NC}"
    ...
    configure_paseo_desktop_channel wsl || return 1
