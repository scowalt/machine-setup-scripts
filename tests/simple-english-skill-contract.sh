...
declare -A expected_banners=(
    [mac.sh]='Install PR Lens across all supported agents'
    [ubuntu.sh]='Install PR Lens across all supported agents'
    [wsl.sh]='Install PR Lens across all supported agents'
    [pi.sh]='Install PR Lens across all supported agents'
    [bazzite.sh]='Install PR Lens across all supported agents'
)
...
assert_contains win.ps1 'Version 136 \| Last changed: Install PR Lens across all supported agents' 'PowerShell version banner'
