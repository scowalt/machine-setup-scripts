...
assert_contains ubuntu.sh 'Version 207 \| Last changed: Install Impeccable across AI harnesses' 'Ubuntu version banner'
assert_contains wsl.sh 'Version 153 \| Last changed: Install Impeccable across AI harnesses' 'WSL version banner'
assert_contains pi.sh 'Version 168 \| Last changed: Install Impeccable across AI harnesses' 'Raspberry Pi version banner'
assert_contains bazzite.sh 'Version 67 \| Last changed: Install Impeccable across AI harnesses' 'Bazzite version banner'
