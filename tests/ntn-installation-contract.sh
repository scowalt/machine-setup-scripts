...
assert_contains mac.sh 'Version 193 \| Last changed: Harden setup idempotency from weekly log audit' 'macOS version banner'
assert_contains ubuntu.sh 'Version 215 \| Last changed: Harden setup idempotency from weekly log audit' 'Ubuntu version banner'
assert_contains wsl.sh 'Version 159 \| Last changed: Harden setup idempotency from weekly log audit' 'WSL version banner'
assert_contains pi.sh 'Version 176 \| Last changed: Harden setup idempotency from weekly log audit' 'Raspberry Pi version banner'
assert_contains bazzite.sh 'Version 75 \| Last changed: Harden setup idempotency from weekly log audit' 'Bazzite version banner'
...
assert_contains win.ps1 'Version 115 \| Last changed: Harden setup idempotency from weekly log audit' 'Windows version banner'
