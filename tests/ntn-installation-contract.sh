...
assert_contains mac.sh 'Version 178 \| Last changed: Install/update Notion CLI' 'macOS version banner'
assert_contains ubuntu.sh 'Version 197 \| Last changed: Install/update Notion CLI' 'Ubuntu version banner'
assert_contains wsl.sh 'Version 148 \| Last changed: Install/update Notion CLI' 'WSL version banner'
assert_contains pi.sh 'Version 158 \| Last changed: Install/update Notion CLI' 'Raspberry Pi version banner'
assert_contains bazzite.sh 'Version 56 \| Last changed: Install/update Notion CLI' 'Bazzite version banner'
...
assert_contains win.ps1 'Version 106 \| Last changed: Install/update Notion CLI' 'Windows version banner'
