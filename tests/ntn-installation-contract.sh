...
assert_contains mac.sh 'Version 191 \| Last changed: Install Pi Ask User extension by default' 'macOS version banner'
assert_contains ubuntu.sh 'Version 213 \| Last changed: Install Pi Ask User extension by default' 'Ubuntu version banner'
assert_contains wsl.sh 'Version 157 \| Last changed: Install Pi Ask User extension by default' 'WSL version banner'
assert_contains pi.sh 'Version 174 \| Last changed: Install Pi Ask User extension by default' 'Raspberry Pi version banner'
assert_contains bazzite.sh 'Version 73 \| Last changed: Install Pi Ask User extension by default' 'Bazzite version banner'
...
assert_contains win.ps1 'Version 113 \| Last changed: Install Pi Ask User extension by default' 'Windows version banner'
