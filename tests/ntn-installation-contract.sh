...
assert_contains mac.sh 'Version 185 \| Last changed: Upload logs after setup failures' 'macOS version banner'
assert_contains ubuntu.sh 'Version 205 \| Last changed: Upload logs after setup failures' 'Ubuntu version banner'
assert_contains wsl.sh 'Version 151 \| Last changed: Upload logs after setup failures' 'WSL version banner'
assert_contains pi.sh 'Version 166 \| Last changed: Upload logs after setup failures' 'Raspberry Pi version banner'
assert_contains bazzite.sh 'Version 65 \| Last changed: Upload logs after setup failures' 'Bazzite version banner'
...
assert_contains win.ps1 'Version 109 \| Last changed: Upload logs after setup failures' 'Windows version banner'
