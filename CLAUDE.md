...
- Install/update through the correct local daemon's native Git plugin commands. Track `main` at `https://github.com/scowalt/paseo-plain.git`. Do not replace other sources, directory installs, pinned refs, or explicit disabled choices.
