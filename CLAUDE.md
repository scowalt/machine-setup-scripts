...
- Future setup runs only: no fleet inventory, SSH rollout, or existing-daemon migration. Do not source full setup scripts in new tests: some platforms call main unconditionally. Extract only the tested function or embedded installer.
