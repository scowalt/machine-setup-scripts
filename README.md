...
Setup installs the managed Matt Pocock engineering skills on personal and work machines. Pi and Codex share the canonical copies in `~/.agents/skills`. opencode reads its copies from `~/.config/opencode/skills`. Work machines also install Google Cloud CLI.
