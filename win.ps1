...
'@
    ...
    try {
        ...
        Write-Warning "Pi Go setup failed: unsafe paths, credentials, catalog, locking, or permissions. Review these locally and rerun setup."
        return $false
    } finally {
        $env:NODE_OPTIONS = $previousNodeOptions
        $env:NODE_PATH = $previousNodePath
...
function Invoke-WindowsSetupTasks {
    ...
    Write-Host "Version 146 | Last changed: Add Go subscription and Muse Contributor profile"
